...
class MediaController extends Controller
{
    ...
    public function index(IndexMedium $request)
    {
        ...
        $data = AdminListing::create(Medium::class)->processRequestAndGet(
            ...
            ['id', 'model_type', 'model_id', 'uuid', 'collection_name', 'name', 'file_name', 'mime_type', 'disk', 'conversions_disk', 'size', 'manipulations', 'custom_properties', 'genrated_conversions', 'responsive_images'],
