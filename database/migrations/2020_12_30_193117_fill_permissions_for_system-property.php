...
class FillPermissionsForSystemProperty extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSystemProperty constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.system-property.index',
            'admin.system-property.create',
            'admin.system-property.show',
            'admin.system-property.edit',
            'admin.system-property.delete',
            'admin.system-property.bulk-delete',
        ]);
