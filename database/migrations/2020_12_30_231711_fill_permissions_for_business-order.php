...
class FillPermissionsForBusinessOrder extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForBusinessOrder constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.business-order.index',
            'admin.business-order.create',
            'admin.business-order.show',
            'admin.business-order.edit',
            'admin.business-order.delete',
            'admin.business-order.bulk-delete',
        ]);
