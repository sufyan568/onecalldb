...
class FillPermissionsForCategorySearchIndex extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCategorySearchIndex constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.category-search-index',
            'admin.category-search-index.index',
            'admin.category-search-index.create',
            'admin.category-search-index.show',
            'admin.category-search-index.edit',
            'admin.category-search-index.delete',
            'admin.category-search-index.bulk-delete',
        ]);
