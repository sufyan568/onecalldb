...
class FillPermissionsForUserSegment extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForUserSegment constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.user-segment',
            'admin.user-segment.index',
            'admin.user-segment.create',
            'admin.user-segment.show',
            'admin.user-segment.edit',
            'admin.user-segment.delete',
            'admin.user-segment.bulk-delete',
        ]);
