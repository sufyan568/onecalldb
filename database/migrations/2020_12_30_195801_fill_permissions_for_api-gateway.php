...
class FillPermissionsForApiGateway extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForApiGateway constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.api-gateway',
            'admin.api-gateway.index',
            'admin.api-gateway.create',
            'admin.api-gateway.show',
            'admin.api-gateway.edit',
            'admin.api-gateway.delete',
            'admin.api-gateway.bulk-delete',
        ]);
