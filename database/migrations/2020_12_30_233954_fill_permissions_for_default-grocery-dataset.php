...
class FillPermissionsForDefaultGroceryDataset extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForDefaultGroceryDataset constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.default-grocery-dataset',
            'admin.default-grocery-dataset.index',
            'admin.default-grocery-dataset.create',
            'admin.default-grocery-dataset.show',
            'admin.default-grocery-dataset.edit',
            'admin.default-grocery-dataset.delete',
            'admin.default-grocery-dataset.bulk-delete',
        ]);
