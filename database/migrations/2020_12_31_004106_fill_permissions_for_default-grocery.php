...
class FillPermissionsForDefaultGrocery extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForDefaultGrocery constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.default-grocery',
            'admin.default-grocery.index',
            'admin.default-grocery.create',
            'admin.default-grocery.show',
            'admin.default-grocery.edit',
            'admin.default-grocery.delete',
            'admin.default-grocery.bulk-delete',
        ]);
