...
class FillPermissionsForBusinessProfile extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForBusinessProfile constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.business-profile.index',
            'admin.business-profile.create',
            'admin.business-profile.show',
            'admin.business-profile.edit',
            'admin.business-profile.delete',
            'admin.business-profile.bulk-delete',
        ]);
