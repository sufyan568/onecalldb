...
class FillPermissionsForQueryMessage extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForQueryMessage constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.query-message',
            'admin.query-message.index',
            'admin.query-message.create',
            'admin.query-message.show',
            'admin.query-message.edit',
            'admin.query-message.delete',
            'admin.query-message.bulk-delete',
        ]);
