...
class FillPermissionsForUserMessge extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForUserMessge constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.user-messge',
            'admin.user-messge.index',
            'admin.user-messge.create',
            'admin.user-messge.show',
            'admin.user-messge.edit',
            'admin.user-messge.delete',
            'admin.user-messge.bulk-delete',
        ]);
