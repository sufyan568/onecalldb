...
class FillPermissionsForBusinessAccount extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForBusinessAccount constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.business-account.index',
            'admin.business-account.create',
            'admin.business-account.show',
            'admin.business-account.edit',
            'admin.business-account.delete',
            'admin.business-account.bulk-delete',
        ]);
