...
class FillPermissionsForBroadcastMessage extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForBroadcastMessage constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.broadcast-message.index',
            'admin.broadcast-message.create',
            'admin.broadcast-message.show',
            'admin.broadcast-message.edit',
            'admin.broadcast-message.delete',
            'admin.broadcast-message.bulk-delete',
        ]);
