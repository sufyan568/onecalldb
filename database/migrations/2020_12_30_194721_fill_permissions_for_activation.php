...
class FillPermissionsForActivation extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForActivation constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.activation.show',
            'admin.activation.edit',
            'admin.activation.delete',
            'admin.activation.bulk-delete',
        ]);
