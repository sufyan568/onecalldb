...
class FillPermissionsForMessageFile extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForMessageFile constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.message-file',
            'admin.message-file.index',
            'admin.message-file.create',
            'admin.message-file.show',
            'admin.message-file.edit',
            'admin.message-file.delete',
            'admin.message-file.bulk-delete',
        ]);
